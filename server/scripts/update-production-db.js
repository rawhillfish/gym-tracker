/**
 * Script to update the production MongoDB database
 * 
 * Usage: NODE_ENV=production node scripts/update-production-db.js
 * 
 * This script will:
...
const main = async () => {
  try {
    ...
    rl.question('You are about to update the PRODUCTION database. Are you sure you want to continue? (yes/no): ', async (answer) => {
